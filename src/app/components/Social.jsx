  ...
  return (
    <div className="mt-5 p-10">
      ...
      <div className="my-8 flex flex-col sm:flex-row justify-center px-6">
          ...
          <span className="flex items-center transition-all duration-200 rounded-md text-sm px-4 py-2">
            ...
            >
              <svg
                ...
                stroke-width="0"
                viewBox="0 0 320 512"
                class="w-4 h-6  cursor-pointer hover:text-[#57009C] focus:text-[#57009C]"
                height="1em"
                width="1em"
        ...
        <button
          type="button"
          class="group flex items-center justify-center p-0.5 text-center font-medium relative focus:z-10 focus:outline-none focus:ring-transparent rounded-lg focus:ring-2 border border-black"
        >
          <span class="flex items-center transition-all duration-200 rounded-md text-sm px-4 py-2">
            ...
            >
              <svg
                ...
                stroke-width="0"
                viewBox="0 0 448 512"
                class="w-6 h-6  cursor-pointer hover:text-[#57009C] focus:text-[#57009C]"
                height="1em"
                width="1em"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <p class="font-medium ml-2">Follow us on Instagram</p>
            </a>
          </span>
        </button>
      </div>
