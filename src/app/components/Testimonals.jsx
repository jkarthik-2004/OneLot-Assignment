...
export default function Testimonials() {
  ...
  return (
    <div className="slider-container bg-white p-8">
      ...
      <Slider ref={sliderRef} {...settings}>
        <div className="flex flex-col justify-center items-center h-64">
          <img
            src="Avatar_1.webp"
            alt="Avatar 1"
            className="mb-4 mx-auto h-30 sm:h-40"
          />
          <p className="font-bold mt-4 p-5">
          ...
          <div className="flex justify-center items-center">
            <p className="text-black font-bold sm:mr-4 text-sm">
              Mark Vergel de Dios
            </p>
      ...
      <div className="text-center mt-4">
        <button
          className=" text-gray-500 font-extrabold text-xl px-4 py-2 rounded-lg mr-2"
          onClick={previous}
        >
          <span>&larr;</span>
        </button>
